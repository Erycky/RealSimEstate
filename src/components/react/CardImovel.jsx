...
export default function CardImovel({ imovel }) {
  // Formata o preço para a realidade da moeda brasileira (R$)
  const formatarPreco = (valor) => {
    return new Intl.NumberFormat('pt-BR', {
      style: 'currency',
      currency: 'BRL',
      maximumFractionDigits: 0 // Remove os centavos para ficar idêntico ao seu design (R$97.000)
    }).format(valor);
  };
  ...
  return (
    <div className="bg-white rounded-3xl shadow-md border border-gray-100 overflow-hidden flex flex-col group hover:shadow-xl transition-shadow duration-300">
      ...
      <div className="p-5 flex items-center justify-between gap-2">
        ...
        {/* 3. BOTÃO DE AÇÃO (Seta para a página de detalhes) */}
        <a 
